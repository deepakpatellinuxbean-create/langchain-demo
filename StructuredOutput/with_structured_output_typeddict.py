#yha hum chatgpt ka use kr rhe hai to get the structured outpot and using the typed dict to create the structure/schema.
...
class Review(TypedDict):
    ...
    # annotated type dict (optional)
    key_themes: Annotated[list[str], "write down all the key themes discussed in the review in a list"]
    summary: Annotated[str, "A brief description of the review"]
    sentiment: Annotated[Literal["+ve", "-ve"], "review's feeling:- negative, positive, or neutral"]
